 ...
 * @version 3.0
 */ 
public class StudentFileAdapterGUI3 extends JFrame
{
    ...
    */
   public StudentFileAdapterGUI3()
   {
      super("Student File Adapter GUI 3.0");
   ...
   /* 
    * private methods don't need Javadocs as no one will call them directly, but we can
    * still add normal comments to describe the methods:
   ...
   {
      StudentFileAdapterGUI3 sfagui3 = new StudentFileAdapterGUI3();
   }
}
